...
class PDF extends FPDF
{
	...
	function SetCol($col){
		...
		$this->col = $col;
		// 65 es 6.5 cm + 1 cm de m�rgen
		$x = 10+$col*65;
		$this->SetLeftMargin($x);
		$this->SetX($x);
	}
	// Sobre escibimos el m�todo
...
$pdf->PrintChapter(1,'UN RIZO DE HUIDA','./fpdf181/tutorial/20k_c1.txt');
$pdf->PrintChapter(2,'LOS PROS Y LOS CONTRAS','./fpdf181/tutorial/20k_c2.txt');
$pdf->Output();
?>