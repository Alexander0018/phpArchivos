<?php
  ...
  //
  $sql = "SELECT * FROM historicoTabularCertezaEnfasis ORDER BY anio";
  //
       ...
       data.addRows([
          <?php
              ...
              while($row=mysqli_fetch_assoc($r)){
                print "['".$row["anio"]."', ".$row["Chrome"].", ".$row["certeza"].", ".$row["IE-Edge"].", ".$row["enfasis"].", ".$row["Firefox"].", ".$row["Safari"].", ".$row["Opera"]."]";
                $i++;
                if($i<$n) print ",";
              }
            ?>
