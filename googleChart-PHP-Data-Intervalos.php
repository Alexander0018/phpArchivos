<?php
  ...
  //
  $sql = "SELECT * FROM historicoTabularIntervalos ORDER BY anio";
  //
       ...
       data.addRows([
          <?php
              ...
              while($row=mysqli_fetch_assoc($r)){
                print "['".$row["anio"]."', ".$row["Chrome"].", ".$row["intervalo1"].", ".$row["intervalo2"].", ".$row["IE-Edge"].", ".$row["Firefox"].", ".$row["Safari"].", ".$row["Opera"]."]";
                $i++;
                if($i<$n) print ",";
              }
            ?>
