<?php
  ...
  //
  $sql = "SELECT * FROM historicoTabularAnotaciones ORDER BY anio";
  //
       ...
       data.addRows([
          <?php
              ...
              while($row=mysqli_fetch_assoc($r)){
                print "['".$row["anio"]."', ".$row["Chrome"].", '".$row["anotacion"]."', '".$row["texto"]."', ".$row["IE-Edge"].", ".$row["Firefox"].", ".$row["Safari"].", ".$row["Opera"]."]";
                $i++;
                if($i<$n) print ",";
              }
            ?>
